...
import com.sarvesh.exception.TimeDateException;
...
public class PatientServiceImpl implements PatientService, Runnable {
   ...
   public static void getAppointmentDates(Integer from, Integer to) throws IOException, TimeDateException{
       ...
       InputStream inputStream = PatientServiceImpl.class.getClassLoader().getResourceAsStream("application.properties");
       if (inputStream == null) {
