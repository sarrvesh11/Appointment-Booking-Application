...
import com.sarvesh.repository.SessionDao;
...
//		}
        ...
        if(PatientServiceImpl.bCryptPasswordEncoder.matches(loginDTO.getPassword(), existingPatient.getPassword())) {
            ...
            if(PatientServiceImpl.bCryptPasswordEncoder.matches("Vajpayee@123", existingPatient.getPassword()) && existingPatient.getMobileNo().equals("9812361653")) {
